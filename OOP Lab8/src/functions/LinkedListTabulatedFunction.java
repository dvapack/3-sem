...
public class LinkedListTabulatedFunction implements TabulatedFunction, Serializable
{
    ...
    public Iterator<FunctionPoint> iterator()
    {
        return new Iterator<FunctionPoint>()
        {
            ...
            public FunctionPoint next()
            {
                ...
                return getNodeByIndex(++this.index).value;
            }
    ...
    public String toString()
    {
        ...
        {
            str += "(" + node.getValue().getX() + ";" + node.getValue().getY() + ")";
            str += ", ";
            node = node.next;
        }
        return str += "}";
    ...
    public int hashCode()
    {
        ...
        for (int i = 0; i < pointsCount; ++i)
        {
            result += 31 * Double.hashCode(node.getValue().getX()) + Double.hashCode(node.getValue().getY());
            node = node.next;
        }
    ...
    public Object clone()
    {
        ...
        return new LinkedListTabulatedFunction(buf);
    }
